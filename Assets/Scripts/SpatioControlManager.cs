...
namespace XRSpatiotemopralAuthoring
{
    public class SpatioControlManager : MonoBehaviour
    {
        ...
        private bool isMeshInteractive = false;
        ...
        private float[] dict;
        private string constructionObjectTag;
        ...
        {
            if (PlatformManager.Instance.platform == PlatformManager.Platform.Editor || PlatformManager.Instance.platform == PlatformManager.Platform.VR || PlatformManager.Instance.platform == PlatformManager.Platform.Desktop)
            {
                constructionObjectTag = "Construction";
            }
            else
            {
                constructionObjectTag = "AR_Construction";
            }
        }
        ...
        public bool GetDataFromID(string name)
        {
            bool found = false;
            //we get the filtered attribute
            //we get the filter min max values_
